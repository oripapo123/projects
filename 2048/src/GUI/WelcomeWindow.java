...
public class WelcomeWindow extends JFrame{
	...
	public WelcomeWindow(){
		...
		JButton designChoose = new JButton("Choose Design");
		designChoose.setPreferredSize(new Dimension(130,30));
		designChoose.addActionListener(new ActionListener() {
	...
	private void clickNewGame(){
		...
		GamePanel game = new GamePanel(this.design);
	}
	...
	private void clickDesignChoose(){
		this.setVisible(false);
